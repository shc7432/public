window.md5=window.MD5=window.toMD5=String.prototype.toMD5=String.prototype.md5=function(string) {
    ...
    string = md5_Utf8Encode(string);    x = md5_ConvertToWordArray(string);    a = 0x67452301;    b = 0xEFCDAB89;    c = 0x98BADCFE;    d = 0x10325476;
...
window.sha1=window.SHA1=window.toSHA1=String.prototype.toSHA1=String.prototype.sha1=function(sIn) {  
    if(this!==window) {sIn=this} else sIn=arguments[0];
    var x = AlignSHA1(sIn);  
    var w = new Array(80);  
    var a = 1732584193;  
    var b = -271733879;  
