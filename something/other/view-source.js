...
window.open('data:text/html;charset=utf-8,<meta name=viewport content="width=device-width">'+'<textarea id=v'+
...
'<a onclick="window.opener.document.documentElement.innerHTML=v.value">Save</a> | <a onclick="window.close()">Close | x</a></span>');
